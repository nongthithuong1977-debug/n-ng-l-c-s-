...
<div class="main-header">
    ...
    <p>Tác giả: Nông Thị Thương- Trường PTDTBT Tiểu học Hữu Vinh - ĐT: 0914802689</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nông Thị Thương - Trường PTDTBT Tiểu học Hữu Vinh - ĐT: 0914802689</div>", unsafe_allow_html=True)
